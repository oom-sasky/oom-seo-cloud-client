...
import H1ItemComponent from './H1ItemComponent';

const H1ItemsComponent = ({ title, reports, lengthType, loading, generating, generatedContent, handleGenerateClick }) => {
  ...
  const handleBulkGenerateClick = async () => {
    ...
    try {
      for (const report of selectedItems) {
        if (report) {
          await handleGenerateClick(report, 'heading_h1', report.pageUrl, report.pageContent);
        }
      }
    } catch (error) {
      console.error("Error generating H1s:", error);
    } finally {
        ...
        <div className="oom-report-details_item-table_data-content-table">
          ...
          {reports.length > 0 && (
            <div className="oom-report-details_item-table_data-content_headings">
              <div className="oom-report-details_item-table_data-content_heading oom-column-40 page-url">
                <input
              ...
              <div className="oom-report-details_item-table_data-content_heading oom-column-5 heading-type">
                <p className="oom-report-details_item-table_data-content_heading_title">Text</p>
              </div>
...
export default H1ItemsComponent;
