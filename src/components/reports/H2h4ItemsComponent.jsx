...
import H2h4ItemComponent from './H2h4ItemComponent';

const H2h4ItemsComponent = ({ title, reports, lengthType, loading, generating, generatedContent, handleGenerateClick }) => {
  ...
  const handleBulkGenerateClick = async () => {
    ...
    try {
      for (const report of selectedItems) {
        if (report) {
          await handleGenerateClick(report, 'heading', report.pageUrl, report.pageContent);
        }
      }
    } catch (error) {
      console.error("Error generating H2H4s:", error);
    } finally {
        ...
        <div className="oom-report-details_item-table_data-content-table">
          ...
          {reports.length > 0 && (
            <div className="oom-report-details_item-table_data-content_headings">
              <div className="oom-report-details_item-table_data-content_heading oom-column-30 page-url">
                <input
              ...
              <div className="oom-report-details_item-table_data-content_heading oom-column-30 title">
                <p className="oom-report-details_item-table_data-content_heading_title">Text</p>
              </div>

              <div className="oom-report-details_item-table_data-content_heading oom-column-10 heading-type">
                <p className="oom-report-details_item-table_data-content_heading_title">Heading</p>
              </div>
              ...
              <div className="oom-report-details_item-table_data-content_heading oom-column-5 title-length">
                <p className="oom-report-details_item-table_data-content_heading_title">Length</p>
              </div>
...
export default H2h4ItemsComponent;
